...
#region Office365 Installation
#try {
#    Start-Process -FilePath "c:\temp\software\Office365\Office365.bat"
#    if (Test-Path "C:\Program Files\Microsoft Office\root\Office16\WINWORD.EXE") {
#        Write-Log "Office365 has been installed"
#    }
#    else {
#        write-log "Error locating the Office365 executable"
#    }
#}
#catch {
#    $ErrorMessage = $_.Exception.message
#    write-log "Error installing Office365: $ErrorMessage"
#}
#endregion
